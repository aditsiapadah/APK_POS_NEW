            ...
            <div class="overflow-x-auto border border-slate-100 rounded-2xl">
                <table class="w-full min-w-[500px]">
                    ...
                    <tbody class="text-slate-700 divide-y">
                        ...
                        @empty
                            <tr><td colspan="3" class="text-center py-8 text-slate-400">Tidak ada produk stok rendah</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
            ...
            <div class="overflow-x-auto border border-slate-100 rounded-2xl">
                <table class="w-full min-w-[500px]">
                    ...
                    <tbody class="text-slate-700 divide-y">
                        ...
                        @empty
                            <tr><td colspan="3" class="text-center py-8 text-slate-400">Tidak ada produk habis stok</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
        ...
        <div class="overflow-x-auto border border-slate-100 rounded-2xl">
            <table class="w-full min-w-[600px]">
                ...
                <tbody class="text-slate-700 divide-y">
                    ...
                    @empty
                        <tr><td colspan="3" class="text-center py-8 text-slate-400">Belum ada penjualan hari ini</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
